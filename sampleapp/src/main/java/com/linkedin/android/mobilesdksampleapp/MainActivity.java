            ...
            public void onClick(View view) {
                LISessionManager.getInstance(getApplicationContext()).init(thisActivity, buildScope(), new AuthListener() {
                    ...
                    public void onAuthSuccess() {
                        ...
                        Log.i("Success", LISessionManager.getInstance(getApplicationContext()).getSession().getAccessToken().toString());
                    }
                    @Override
            ...
            public void onClick(View v) {
                try {
                    ...
                    for (Signature signature : info.signatures) {
                        ...
                        Log.i("HASH", "package: " + ((TextView) findViewById(R.id.pckText)).getText().toString());
                        Log.i("HASH", "hash: " + ((TextView) findViewById(R.id.pckHashText)).getText().toString());
                    }
